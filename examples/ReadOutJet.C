...
void AnalyseEvents(ExRootTreeReader *treeReader, TestPlots *plots, TTree *evtree)
{
...
void ReadOutJet()
{
  ...
  AnalyseEvents(treeReader, plots, evtree);

  PrintHistograms(result, plots);

  TFile *file = new TFile("DiHiggs_htobb.root","recreate");
  evtree->Write();
  file->Close();
